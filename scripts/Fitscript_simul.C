...
//sigType = 0 for Hypatia, 1 for Double sided Crystal Ball.
{
	...
	for(Int_t run = 1; run<=2; run++)
	{
		...
		framesigma->GetXaxis()->SetTitle("m_{J/#psi#Lambda}[MeV]");
	...
	for(Int_t run = 1; run<=2; run++)
	{
		...
		frame1405->GetXaxis()->SetTitle("m_{J/#psi#Lambda}[MeV]");
	...
	for(Int_t run = 1; run<=2; run++)
	{
		...
		frame1520->GetXaxis()->SetTitle("m_{J/#psi#Lambda}[MeV]");
	...
	for(Int_t run = 1; run<=2; run++)
	{
		...
		frame1600->GetXaxis()->SetTitle("m_{J/#psi#Lambda}[MeV]");
	...
	simframe_Run1->GetXaxis()->SetTitle("m_{J/#psi#Lambda}[MeV]");
	...
	simframe_Run2->GetXaxis()->SetTitle("m_{J/#psi#Lambda}[MeV]");
	...
	frame_run1->GetXaxis()->SetTitle("m_{J/#psi#Lambda}[MeV]");
	...
	simPdf.plotOn(frame_run1,Slice(sample,"run1"),ProjWData(sample,*combData),Components(*(w.pdf("Bkg_Run1"))),LineColor(kRed-6),Name("bkg_Run1"),LineStyle(3));
	simPdf.plotOn(frame_run1,Slice(sample,"run1"),ProjWData(sample,*combData),Components(*(w.pdf("XIB_RUN1"))),LineColor(kGreen+2),Name("xib_Run1"));
	if(lst1405flag)
	...
	simPdf.plotOn(frame_run1,Slice(sample,"run1"),ProjWData(sample,*combData),Components(*(w.pdf("SIG_Run1"))),LineColor(kBlack),Name("sig_Run1"),LineStyle(5));
	...
	if(xib0flag)
		simPdf.plotOn(frame_run1,Slice(sample,"run1"),ProjWData(sample,*combData),Components(*(w.pdf("Xib_Run1"))),LineColor(kRed-1),LineStyle(6),Name("Xib_JpsiLambda_Run1"));
	if(jpsiksflag)
	...
	auto legend_run1_2 = new TLegend(0.45,0.7,0.65,0.9);
	...
	legend_run1_2->AddEntry("sig_Run1","#Lambda_{b} #rightarrow J/#psi #Sigma @ R = 0.2%","l");
	...
	if(xib0flag)
	{
		legend_run1->AddEntry("Xib_JpsiLambda_Run1","#Xi_{b}^{0} #rightarrow J/#psi #Lambda","l");
	}
	if(lst1405flag)
	{
	...
	// frame_run1x2->GetXaxis()->SetTitle("m_{J/#psi#Lambda}[MeV]");
	...
	frame_zoom_run1->GetXaxis()->SetTitle("m_{J/#psi#Lambda}[MeV]");
	...
	simPdf.plotOn(frame_zoom_run1,Slice(sample,"run1"),ProjWData(sample,*combData),Components(*(w.pdf("Bkg_Run1"))),LineColor(kRed-6),Name("bkg_Run1"),LineStyle(3));
	simPdf.plotOn(frame_zoom_run1,Slice(sample,"run1"),ProjWData(sample,*combData),Components(*(w.pdf("XIB_RUN1"))),LineColor(kGreen+2),Name("xib_Run1"));
	if(lst1405flag)
	...
	simPdf.plotOn(frame_zoom_run1,Slice(sample,"run1"),ProjWData(sample,*combData),Components(*(w.pdf("SIG_Run1"))),LineColor(kBlack),Name("sig_Run1"),LineStyle(5));
	...
	if(xib0flag)
		simPdf.plotOn(frame_zoom_run1,Slice(sample,"run1"),ProjWData(sample,*combData),Components(*(w.pdf("Xib_Run1"))),LineColor(kRed-1),LineStyle(6),Name("Xib_JpsiLambda_Run1"));
	if(jpsiksflag)
	...
	legend_zoom_run1->AddEntry("sig_Run1","#Lambda_{b} #rightarrow J/#psi #Sigma @ R = 0.2%","l");
	...
	if(xib0flag)
	{
		legend_zoom_run1->AddEntry("Xib_JpsiLambda_Run1","#Xi_{b}^{0} #rightarrow J/#psi #Lambda","l");
	}
	if(lst1405flag)
	{
	...
	// frame_zoom_run1x2->GetXaxis()->SetTitle("m_{J/#psi#Lambda}[MeV]");
	...
	frame_run2->GetXaxis()->SetTitle("m_{J/#psi#Lambda}[MeV]");
	...
	simPdf.plotOn(frame_run2,Slice(sample,"run2"),ProjWData(sample,*combData),Components(*(w.pdf("Bkg_Run2"))),LineColor(kRed-6),Name("bkg_Run2"),LineStyle(3));
	simPdf.plotOn(frame_run2,Slice(sample,"run2"),ProjWData(sample,*combData),Components(*(w.pdf("XIB_RUN2"))),LineColor(kGreen+2),Name("xib_Run2"));
	if(lst1405flag)
	...
	simPdf.plotOn(frame_run2,Slice(sample,"run2"),ProjWData(sample,*combData),Components(*(w.pdf("SIG_Run2"))),LineColor(kBlack),Name("sig_Run2"),LineStyle(5));
	...
	if(xib0flag)
		simPdf.plotOn(frame_run2,Slice(sample,"run2"),ProjWData(sample,*combData),Components(*(w.pdf("Xib_Run2"))),LineColor(kRed-1),LineStyle(6),Name("Xib_JpsiLambda_Run2"));
	if(jpsiksflag)
	...
	auto legend_run2_2 = new TLegend(0.45,0.7,0.65,0.9);
	...
	if(xib0flag)
	{
		legend_run2->AddEntry("Xib_JpsiLambda_Run2","#Xi_{b}^{0} #rightarrow J/#psi #Lambda","l");
	}
	if(lst1405flag)
	{
	...
	// frame_run2x2->GetXaxis()->SetTitle("m_{J/#psi#Lambda}[MeV]");
	...
	frame_zoom_run2->GetXaxis()->SetTitle("m_{J/#psi#Lambda}[MeV]");
	...
	simPdf.plotOn(frame_zoom_run2,Slice(sample,"run2"),ProjWData(sample,*combData),Components(*(w.pdf("Bkg_Run2"))),LineColor(kRed-6),Name("bkg_Run2"),LineStyle(3));
	simPdf.plotOn(frame_zoom_run2,Slice(sample,"run2"),ProjWData(sample,*combData),Components(*(w.pdf("XIB_RUN2"))),LineColor(kGreen+2),Name("xib_Run2"));
	if(lst1405flag)
	...
	simPdf.plotOn(frame_zoom_run2,Slice(sample,"run2"),ProjWData(sample,*combData),Components(*(w.pdf("SIG_Run2"))),LineColor(kBlack),Name("sig_Run2"),LineStyle(5));
	...
	if(xib0flag)
		simPdf.plotOn(frame_zoom_run2,Slice(sample,"run2"),ProjWData(sample,*combData),Components(*(w.pdf("Xib_Run2"))),LineColor(kRed-1),LineStyle(6),Name("Xib_JpsiLambda_Run2"));
	if(jpsiksflag)
	...
	legend_zoom_run2->SetTextSize(0.03);
	...
	legend_zoom_run2->AddEntry("sig_Run2","#Lambda_{b} #rightarrow J/#psi #Sigma @ R = 0.2%","l");
	...
	if(xib0flag)
	{
		legend_zoom_run2->AddEntry("Xib_JpsiLambda_Run2","#Xi_{b}^{0} #rightarrow J/#psi #Lambda","l");
	}
	if(lst1405flag)
	{
	...
	// frame_zoom_run2x2->GetXaxis()->SetTitle("m_{J/#psi#Lambda}[MeV]");
