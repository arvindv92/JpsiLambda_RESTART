...
void Fitscript_simul(Int_t myLow = 4700, Int_t myHigh = 6000, Int_t Lst1405_rwtype = 0, Int_t bkgType = 0, Int_t sigType = 0, Float_t bdtCut = 0.0, const char* fileName = "tempModel.root");
