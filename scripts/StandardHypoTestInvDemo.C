...
void ReadResult(const char * fileName, const char * resultName="", bool useCLs=true, Int_t myLow = 4700, Int_t myHigh = 6000) {
	// read a previous stored result from a file given the result name

	StandardHypoTestInvDemo(fileName, resultName,"","","",0,0,useCLs,myLow,myHigh);
}
