...
{/*Set LstXXXXflag = 1 to include the shapes for these decays in the final fit
  ...
  treein_lst1405->Draw(TString::Format("JpsiLmass>>hlst1405(%d,%d,%d)",nbins,low,high),lst1405wtexp,"goff");
  ...
  //  RooDataSet ds_lst("ds_lst","ds_lst",treein_lst,RooArgSet(lstmass,MVweight),"MVweight");
  treein_lst1520->Draw(TString::Format("JpsiLmass>>hlst1520(%d,%d,%d)",nbins,low,high),"","goff");
  ...
  //  RooDataSet ds_lst("ds_lst","ds_lst",treein_lst,RooArgSet(lstmass,MVweight),"MVweight");
  treein_lst1810->Draw(TString::Format("JpsiLmass>>hlst1810(%d,%d,%d)",nbins,low,high),"","goff");
  ...
  treein_xib->Draw(TString::Format("Lb_DTF_M_JpsiLConstr>>hxib(%d,%d,%d)",nbins,low,high),"","goff");
  ...
  treein_sigma->Draw(TString::Format("Lb_DTF_M_JpsiLConstr>>hsigma(%d,%d,%d)",nbins,low,high),"","goff");
