...
void AddModel(RooWorkspace* ws){
  ...
  // SIGNAL MODEL
  RooRealVar mB("mB", "B Mass", 5.27908e+03, "MeV");
  RooRealVar sigmaB1("sigmaB1", "Width of Gaussian1",7.51971e+00 ,"MeV");
  RooRealVar sigmaB2("sigmaB2", "Width of Gaussian2", 1.36722e+01,"MeV");
  ...
  RooRealVar f1("f1","fraction",6.20730e-01);
  ...
  RooRealVar c0("c0","coefficient #0", -1.45520e-01);
  RooRealVar c1("c1","coefficient #1", -2.27969e-02);
  ...
  RooRealVar sigYield("sigYield","fitted yield for sig",2.13176e+05) ;
  RooRealVar bkgYield("bkgYield","fitted yield for bkg",2.97442e+05) ;
